...
var showAlert = function showAlert(type, msg) {
  ...
  if (typeof alertNotification != 'undefined' && alertNotification != null) {
    ...
    alertNotification.className = "alert alert--".concat(type);
    alertNotification.innerHTML = "".concat(msg, " <span> ").concat(div.outerHTML, " </span>");
  } else {
  ...
  var hideAlert = document.getElementById('hideAlertNotification');
  var ViewAlert = document.getElementById("alert-notification");
  if (hideAlert) hideAlert.addEventListener('click', function () {
...
var createOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(businessAccount, product, name, email, address, state, area, phone, altphone, qty, total, colour, size, submitbtn) {
    var res, orderId;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _index.stopLoadingBtnSpinner)(submitbtn);
  ...
  return function createOrder(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
    return _ref.apply(this, arguments);
  };
}();

exports.createOrder = createOrder;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"orders.js":[function(require,module,exports) {
"use strict";
...
var createOrderInput = function createOrderInput(e) {
  e.preventDefault();
  var businessAccount = document.getElementById('create_order_businessAccountID').value;
  ...
  if (one_Order_price) {
    ...
    var total = document.getElementById('show_Product_total').value.replace('₦', ' ').replace(/\D/g, '');
    ...
    var _total = productQtyValue.split('=')[1].split(' ')[1];
    var productTotal = parseInt(_total);
  }
  ...
  (0, _index.loadingBtnSpinner)(submitButton);
  (0, _create.createOrder)(businessAccount, product, name, email, address, state, area, phone, altphone, productQty, productTotal, colour, size, submitButton);
};

exports.createOrderInput = createOrderInput;
},{"./create":"create.js","./index":"index.js"}],"signup_loginAPI.js":[function(require,module,exports) {
"use strict";
...
var login_Signup_Update_OrderEmail = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _context.prev = 6;
            _context.t0 = _context["catch"](0);
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context.t0.response.data.message));
  ...
  return function login_Signup_Update_OrderEmail() {
    return _ref.apply(this, arguments);
  };
}();

var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(firstName, lastName, email, phoneNumber, password, submitButton) {
    var res, dataErrors, rawErrorMsg, keys, validationErrorMessage, _i, _Object$entries, _Object$entries$_i, key, value;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (_context2.t0.response.data.error._message) {
              if (_context2.t0.response.data.error._message === 'User validation failed') {
                dataErrors = _context2.t0.response.data.error.errors;
                rawErrorMsg = {};
                keys = Object.keys(dataErrors);
                keys.forEach(function (key) {
                  var message = dataErrors[key].message;

                  if (dataErrors[key].properties && dataErrors[key].properties.message) {
                    message = dataErrors[key].properties.message.replace('`{PATH}`', key);
                  }
                ...
                for (_i = 0, _Object$entries = Object.entries(rawErrorMsg); _i < _Object$entries.length; _i++) {
                  _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
                  validationErrorMessage.push(value);
                }

                (0, _alert.showAlert)('error', validationErrorMessage);
...
var login = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(email, password, submitButton) {
    var res;
...
var resetPassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(password, token) {
    var res;
...
exports.updateOrderEmails = void 0;
...
var updateOrderEmails = /*#__PURE__*/function () {
  ...
  return function updateOrderEmails() {
    return _ref.apply(this, arguments);
  };
}();

exports.updateOrderEmails = updateOrderEmails;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"signup_login.js":[function(require,module,exports) {
"use strict";
...
var _signup_loginAPI = require("./signup_loginAPI");
...
var signupInput = function signupInput(e) {
  ...
  var submitButton = e.submitter;
  (0, _index.loadingBtnSpinner)(submitButton);
  (0, _signup_loginAPI.signup)(firstName, lastName, email, phoneNumber, password, submitButton);
};
...
var loginInput = function loginInput(e) {
  ...
  var submitButton = e.submitter;
  (0, _index.loadingBtnSpinner)(submitButton);
  (0, _signup_loginAPI.login)(email, password, submitButton);
};

exports.loginInput = loginInput;
},{"./signup_loginAPI":"signup_loginAPI.js","./index":"index.js"}],"forgot_resetPass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPassInput = exports.forgotPassInput = void 0;
...
var forgotPassInput = function forgotPassInput(e) {
  ...
  (0, _signup_loginAPI.forgotPassword)(email);
};
...
var resetPassInput = function resetPassInput(e) {
  ...
  var confirmPassword = document.getElementById('reset-confirm-password');
  var token = document.getElementById('forgotPassToken').value;

  if (password != confirmPassword) {
    alert('New and confirm password must be the same');
  } else (0, _signup_loginAPI.resetPassword)(password, token);
};

exports.resetPassInput = resetPassInput;
},{"./signup_loginAPI":"signup_loginAPI.js"}],"index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadingBtnSpinner = loadingBtnSpinner;
exports.stopLoadingBtnSpinner = stopLoadingBtnSpinner;
...
var updateordersbtn = document.getElementById('#refresh_ordersbtn');
var updateordersbtnmobile = document.getElementById('refresh_mobile_ordersbtn');
...
if (Logout) Logout.addEventListener('click', _signup_loginAPI.logout);
...
function loadingBtnSpinner(submitButton) {
...
function stopLoadingBtnSpinner(submitButton) {
  submitButton.classList.remove('btnLoadingSpiner');
...
if (updateordersbtn) updateordersbtn.addEventListener('click', function (e) {
  (0, _update.updateOrderEmails)();
});
if (updateordersbtnmobile) updateordersbtnmobile.addEventListener('click', function (e) {
  (0, _update.updateOrderEmails)();
});
