...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"create.js":[function(require,module,exports) {
"use strict";
...
var updateProduct = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(productName, price, stock, additionalInfo, discount, colours, sizes) {
  ...
  return function updateProduct(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref5.apply(this, arguments);
  };
}();
...
var updateDelivery = /*#__PURE__*/function () {
  ...
  return function updateDelivery(_x14) {
    return _ref6.apply(this, arguments);
  };
}();

exports.updateDelivery = updateDelivery;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var selectPriceOptions = document.querySelector('.selectPriceOptions'); // const addbtn = document.querySelector('#add');
...
if (busloginForm) busloginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  (0, _login.busLogin)(businsessEmail, busisnessPassword);
});
if (logoutBus) logoutBus.addEventListener('click', _login.busLogout);
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(firstName, lastName, email, phoneNumber, password);
});
if (busSignupForm) busSignupForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  (0, _signup.busSignup)(businessName, businessEmail, businessPhoneNumber, businessPassword);
});
if (forgotForm) forgotForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('forgot-email').value;
  (0, _signup.forgotPassword)(email);
});
if (resetPassForm) resetPassForm.addEventListener('submit', function (e) {
  ...
  } else (0, _signup.resetPassword)(password);
});
if (busForgotForm) busForgotForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var businessEmail = document.getElementById('bus-forgot-email').value;
  (0, _signup.busForgotPassword)(businessEmail);
});
if (resetBusPassForm) resetBusPassForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  if (businessPassword != confirmPassword) {
    alert('New and confirm password must be the same');
  } else (0, _signup.busResetPassword)(businessPassword);
});
if (createProductForm) createProductForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (editProductForm) editProductForm.addEventListener('submit', function (e) {
  ...
  (0, _update.updateProduct)(productName, price, stock, additionalInfo, discount, colours, sizes);
});
...
if (createOrderForm) createOrderForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
var successpage = (document.getElementById('successpage') || {}).value;
...
if (selectPriceOptions) {
  ...
  var newPromoQtyArray = PromoQtyArray.slice(' 0 = 0 Niara', 2); // console.log(newPromoQtyArray);
...
var productPriceTypeForm = document.querySelector('#productPriceType');
if (productPriceTypeForm) productPriceTypeForm.addEventListener('change', function () {
...
$('#display_description').html(x); // $(window).on(function() {
