...
var showAlert = function showAlert(type, msg) {
  ...
  var divMarkup = document.createElement('div');
  divMarkup.className = "alert alert--".concat(type);
  divMarkup.innerHTML = "".concat(msg, " <span> ").concat(div.outerHTML, " </span>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', divMarkup.outerHTML);
  var hideAlert = document.getElementsByClassName('hideAlert')[0];
  var ViewAlert = document.getElementsByClassName("alert alert--".concat(type))[0];
...
},{}],"create.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createOrder = exports.createCart = exports.createProduct = void 0;
...
var createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productName, price, stock, additionalInfo, discount, colours, sizes, promoQtyPrice) {
    var res, productSlug, productId;
          ...
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                colours: colours,
                sizes: sizes,
                promoQtyPrice: promoQtyPrice
              }
            });

          case 3:
            res = _context.sent;
            productSlug = res.data.data.newProduct.slug;
            productId = res.data.data.newProduct._id;
  ...
  return function createProduct(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
...
var createCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(qty, total, colour, size) {
    var res, cartId;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            cartId = res.data.data.newCart._id;

            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Cart created Successfully!');
              window.setTimeout(function () {
                location.assign("/createorder/".concat(_index.submitlink, "/").concat(cartId));
              }, 1500);
            }
  ...
  return function createCart(_x9, _x10, _x11, _x12) {
...
var createOrder = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(businessUser, cart, product, name, email, address, state, area, phone, altphone, user) {
    var res, orderId;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Order details was created Successfully!');
              window.setTimeout(function () {
                location.assign("/orderInfo/".concat(orderId));
              }, 1500);
            }
  ...
  return function createOrder(_x13, _x14, _x15, _x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23) {
    return _ref3.apply(this, arguments);
  };
}();

exports.createOrder = createOrder;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"update.js":[function(require,module,exports) {
"use strict";
...
var updatePixel = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(facebookPixel) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Pixel has been Updated. Refresh this page and check your facebook pixel Helper Extention');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function updatePixel(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateTags = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tags) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/orders/".concat(_index.orderId),
              data: {
                tags: tags
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Tags Created');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function updateTags(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateOrderEmails = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(orders) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Order Updated successfully');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alert.showAlert)('error', 'It seems we cannot find any order with your email Address. If you think this is an error, kindly contact us');
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context3.t0.response.data.message));
  ...
  return function updateOrderEmails(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.updateOrderEmails = updateOrderEmails;

var updateShippingOrder = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(OrderId, logisticName, trackingNum) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Order has been marked as shipped');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
          ...
          case 7:
            ...
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context4.t0.response.data.message));
  ...
  return function updateShippingOrder(_x4, _x5, _x6) {
...
var updateProduct = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(productName, price, stock, additionalInfo, discount, colours, sizes, promoQtyPrice) {
  ...
  return function updateProduct(_x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
...
var updateDelivery = /*#__PURE__*/function () {
  ...
  return function updateDelivery(_x15) {
    return _ref6.apply(this, arguments);
  };
}();

exports.updateDelivery = updateDelivery;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"product.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editProductInput = exports.createProductInput = void 0;
...
/* eslint-disable */
var createProductInput = function createProductInput(e) {
  e.preventDefault();
  var productName = document.getElementById('productName').value;
  var price = document.getElementById('productPrice').value || 0;
  var stock = document.getElementById('productStock').value;
  var additionalInfo = document.getElementById('additionalInfo').value;
  var discount = document.getElementById('inputDiscount').value;
  var colours = document.getElementById('color-tags').value;
  var sizes = document.getElementById('size-tags').value;
  var promoQty = document.getElementById('promoQty').value || 0;
  var promoPrice = document.getElementById('promoPrice').value || 0;
  var promoQty2 = document.getElementById('promoQty2').value || 0;
  var promoPrice2 = document.getElementById('promoPrice2').value || 0;
  var promoQty3 = document.getElementById('promoQty3').value || 0;
  var promoPrice3 = document.getElementById('promoPrice3').value || 0;
  var promoQty4 = document.getElementById('promoQty4').value || 0;
  var promoPrice4 = document.getElementById('promoPrice4').value || 0;
  var promoPriceQty = "".concat(promoQty, " = ").concat(promoPrice, " Naira, ").concat(promoQty2, " = ").concat(promoPrice2, " Naira, ").concat(promoQty3, " = ").concat(promoPrice3, " Naira, ").concat(promoQty4, " = ").concat(promoPrice4, " Naira");

  if (price > 0 && promoPriceQty.split(',')[0] != '0 = 0 Naira') {
    alert("You can't use one Price and Varient at the same time");
  } else (0, _create.createProduct)(productName, price, stock, additionalInfo, discount, colours, sizes, promoPriceQty);
};

exports.createProductInput = createProductInput;

var editProductInput = function editProductInput(e) {
  e.preventDefault();
  var productName = document.getElementById('editproductName').value;
  var price = (document.getElementById('editproductPrice') || 0).value;
  ...
  var colours = document.getElementById('edit-color-tags').value;
  var sizes = document.getElementById('edit-size-tags').value;
  var promoQty = document.getElementById('editPromoQty').value || 0;
  var promoPrice = document.getElementById('editPromoPrice').value || 0;
  var promoQty2 = document.getElementById('editPromoQty2').value || 0;
  var promoPrice2 = document.getElementById('editPromoPrice2').value || 0;
  var promoQty3 = document.getElementById('editPromoQty3').value || 0;
  var promoPrice3 = document.getElementById('editPromoPrice3').value || 0;
  var promoQty4 = document.getElementById('editPromoQty4').value || 0;
  var promoPrice4 = document.getElementById('editPromoPrice4').value || 0;
  var promoPriceQty = "".concat(promoQty, " = ").concat(promoPrice, " Naira, ").concat(promoQty2, " = ").concat(promoPrice2, " Naira, ").concat(promoQty3, " = ").concat(promoPrice3, " Naira, ").concat(promoQty4, " = ").concat(promoPrice4, " Naira");

  if (price > 0 && promoPriceQty.split(',')[0] != '0 = 0 Naira') {
    alert("You can't use one Price and Varient at the same time");
  } else (0, _update.updateProduct)(productName, price, stock, additionalInfo, discount, colours, sizes, promoPriceQty);
};

exports.editProductInput = editProductInput;
},{"./create":"create.js","./update":"update.js"}],"orders.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createCartInput = exports.createOrderInput = void 0;

var _create = require("./create");

/* eslint-disable */
var createOrderInput = function createOrderInput(e) {
  e.preventDefault();
  ...
  var area = document.getElementById('checkoutarea').value;
  var phone = document.getElementById('checkoutphone').value;
  var altphone = document.getElementById('checkoutphone2').value;
  (0, _create.createOrder)(businessUser, cart, product, name, email, address, state, area, phone, altphone);
  e.srcElement[10].textContent = 'Processing...';
};

exports.createOrderInput = createOrderInput;

var createCartInput = function createCartInput(e) {
  e.preventDefault();
  var one_Order_price = document.querySelector('.place_order_one_price');

  if (one_Order_price) {
    var productQty = document.getElementById('show_Product_Quantity').value;
    var productTotal = document.getElementById('show_Product_total').value.replace('₦', ' ').replace(/\D/g, '');
  }

  var select_order_price = document.querySelector('.place_order_select_price');
  ...
  var colourSelect = document.getElementById('selectColours');

  if (colourSelect) {
    var colour = colourSelect.options[colourSelect.selectedIndex].value;
  }

  var sizeSelect = document.getElementById('selectSizes');

  if (sizeSelect) {
    var size = sizeSelect.options[sizeSelect.selectedIndex].value;
  }

  (0, _create.createCart)(productQty, productTotal, colour, size);
};

exports.createCartInput = createCartInput;
},{"./create":"create.js"}],"loginAPI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.logout = exports.busLogout = exports.busLogin = exports.login = void 0;
...
var busLogin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(businessEmail, businessPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function busLogin(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.busLogin = busLogin;

var busLogout = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alert.showAlert)('error', 'Unable to Log out right now. Try again later');
  ...
  return function busLogout() {
    return _ref3.apply(this, arguments);
  };
}();

exports.busLogout = busLogout;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"signupAPI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.busResetPassword = exports.busForgotPassword = exports.resetPassword = exports.forgotPassword = exports.busSignup = exports.signup = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, email, phoneNumber, password) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var busSignup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(businessName, businessEmail, businessPhoneNumber, businessPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function busSignup(_x6, _x7, _x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();

exports.busSignup = busSignup;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Successfully! Check Your email Address ".concat(email, " for Instruction"));
            }
...
var resetPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/resetPassword/".concat(_index.token),
              data: {
                password: password
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your Password was succesfully Changed");
              window.setTimeout(function () {
                location.assign('/dashboard');
              }, 1500);
            }
  ...
  return function resetPassword(_x11) {
    return _ref4.apply(this, arguments);
  };
}();
...
var busForgotPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(businessEmail) {
    var res;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Successfully! Check Your email Address ".concat(businessEmail, " for Instruction"));
            }
  ...
  return function busForgotPassword(_x12) {
    return _ref5.apply(this, arguments);
  };
}();

exports.busForgotPassword = busForgotPassword;

var busResetPassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(businessPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/businessUsers/resetPassword/".concat(_index.busToken),
              data: {
                businessPassword: businessPassword
              }
            });
  ...
  return function busResetPassword(_x13) {
    return _ref6.apply(this, arguments);
  };
}();

exports.busResetPassword = busResetPassword;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"signup_login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.busLoginInput = exports.loginInput = exports.busSignupInput = exports.signupInput = void 0;

var _signupAPI = require("./signupAPI");

var _loginAPI = require("./loginAPI");

/* eslint-disable */
var signupInput = function signupInput(e) {
  e.preventDefault();
  ...
  (0, _signupAPI.signup)(firstName, lastName, email, phoneNumber, password);
};

exports.signupInput = signupInput;

var busSignupInput = function busSignupInput(e) {
  e.preventDefault();
  var businessName = document.getElementById('input-bus-name').value;
  var businessEmail = document.getElementById('input-bus-email').value;
  var businessPhoneNumber = document.getElementById('input-bus-phone').value;
  var businessPassword = document.getElementById('input-bus-password').value;
  (0, _signupAPI.busSignup)(businessName, businessEmail, businessPhoneNumber, businessPassword);
};

exports.busSignupInput = busSignupInput;

var loginInput = function loginInput(e) {
  e.preventDefault();
  var email = document.getElementById('email-login').value;
  var password = document.getElementById('pass-login').value;
  (0, _loginAPI.login)(email, password);
};

exports.loginInput = loginInput;

var busLoginInput = function busLoginInput(e) {
  e.preventDefault();
  var businsessEmail = document.getElementById('email-bus-login').value;
  var busisnessPassword = document.getElementById('pass-bus-login').value;
  (0, _loginAPI.busLogin)(businsessEmail, busisnessPassword);
};

exports.busLoginInput = busLoginInput;
},{"./signupAPI":"signupAPI.js","./loginAPI":"loginAPI.js"}],"forgot_resetPass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.busResetPassInput = exports.busForgotPassInput = exports.resetPassInput = exports.forgotPassInput = void 0;

var _signupAPI = require("./signupAPI");

/* eslint-disable */
var forgotPassInput = function forgotPassInput(e) {
  e.preventDefault();
  var email = document.getElementById('forgot-email').value;
  (0, _signupAPI.forgotPassword)(email);
};

exports.forgotPassInput = forgotPassInput;

var resetPassInput = function resetPassInput(e) {
  e.preventDefault();
  ...
  } else (0, _signupAPI.resetPassword)(password);
};

exports.resetPassInput = resetPassInput;

var busForgotPassInput = function busForgotPassInput(e) {
  e.preventDefault();
  var businessEmail = document.getElementById('bus-forgot-email').value;
  (0, _signupAPI.busForgotPassword)(businessEmail);
};

exports.busForgotPassInput = busForgotPassInput;

var busResetPassInput = function busResetPassInput(e) {
  e.preventDefault();
  var businessPassword = document.getElementById('reset-bus-password').value;
  var confirmPassword = document.getElementById('reset-bus-confirm-password').value;

  if (businessPassword != confirmPassword) {
    alert('New and confirm password must be the same');
  } else (0, _signupAPI.busResetPassword)(businessPassword);
};

exports.busResetPassInput = busResetPassInput;
},{"./signupAPI":"signupAPI.js"}],"index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.productId = exports.DelOrderId = exports.orderId = exports.busToken = exports.token = exports.submitlink = void 0;
...
var _signup_login = require("./signup_login");

var _forgot_resetPass = require("./forgot_resetPass");

var submitlink = (document.getElementById('submitlinkinput') || {}).value;
exports.submitlink = submitlink;
var token = (document.getElementById('forgotPassToken') || {}).value;
exports.token = token;
var busToken = (document.getElementById('forgotBusPassToken') || {}).value;
exports.busToken = busToken;
...
var resetPassForm = document.querySelector('.reset-pass-form');
var busForgotForm = document.querySelector('.bus-forgot-form');
var resetBusPassForm = document.querySelector('.reset-bus-pass-form');
...
var createCartForm = document.querySelector('.cart-details');
...
var updateFormmobile = document.getElementById('updateFormmobile');
var updateShipingForm = document.getElementById('shippingForm');
var updateDeliveryForm = document.getElementById('deliveryForm');
var selectColorOptions = document.querySelector('.selectColorOptions');
var selectSizeOptions = document.querySelector('.selectSizeOptions');
var selectPriceOptions = document.querySelector('.selectPriceOptions');
if (loginForm) loginForm.addEventListener('submit', _signup_login.loginInput);
if (busloginForm) busloginForm.addEventListener('submit', _signup_login.busLoginInput);
if (logoutBus) logoutBus.addEventListener('click', _loginAPI.busLogout);
if (Logout) Logout.addEventListener('click', _loginAPI.logout);
if (signupForm) signupForm.addEventListener('submit', _signup_login.signupInput);
if (busSignupForm) busSignupForm.addEventListener('submit', _signup_login.busSignupInput);
if (forgotForm) forgotForm.addEventListener('submit', _forgot_resetPass.forgotPassInput);
if (resetPassForm) resetPassForm.addEventListener('submit', _forgot_resetPass.resetPassInput);
if (busForgotForm) busForgotForm.addEventListener('submit', _forgot_resetPass.busForgotPassInput);
if (resetBusPassForm) resetBusPassForm.addEventListener('submit', _forgot_resetPass.busResetPassInput);
if (createProductForm) createProductForm.addEventListener('submit', _product.createProductInput);
if (editProductForm) editProductForm.addEventListener('submit', _product.editProductInput);
if (createCartForm) createCartForm.addEventListener('submit', _orders.createCartInput);
$('#show_Product_Quantity').on('keyup click', function () {
  var tot = $('#product_price_hidden').val() * this.value;
  var total = "That's \u20A6".concat(tot.toLocaleString());
  $('#show_Product_total').val(total);
  console.log('hereee');
});
var show_product_Price_Qty = document.querySelector('#selectPromoPrice');
if (show_product_Price_Qty) show_product_Price_Qty.addEventListener('change', function (e) {
  e.preventDefault();
  var productTotal = e.target.value.split('=')[1].split(' ')[1];
  var total = "That's \u20A6".concat(parseInt(productTotal).toLocaleString());
  $('#show_Product_total').val(total);
});
if (pixelForm) pixelForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var facebookPixel = document.getElementById('pixelId').value;
  (0, _update.updatePixel)(facebookPixel);
});
if (tagsForm) tagsForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var tags = document.getElementById('order-tags').value;
  (0, _update.updateTags)(tags);
});
if (updateForm) updateForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var orders = document.getElementById('ordersemail').value;
  (0, _update.updateOrderEmails)(orders);
});
if (updateFormmobile) updateFormmobile.addEventListener('submit', function (e) {
  e.preventDefault();
  var orders = document.getElementById('ordersemail').value;
  (0, _update.updateOrderEmails)(orders);
});
if (createOrderForm) createOrderForm.addEventListener('submit', _orders.createOrderInput);
if (updateShipingForm) updateShipingForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var OrderId = document.getElementById('OrderId').value;
  var logisticName = document.getElementById('logName').value;
  var trackingNum = document.getElementById('logNum').value;
  (0, _update.updateShippingOrder)(OrderId, logisticName, trackingNum);
});
if (updateDeliveryForm) updateDeliveryForm.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _update.updateDelivery)();
}); //
// if (submitbtn)
//
...
function payWithPaystack(e) {
  ...
  var handler = PaystackPop.setup({
    key: 'pk_live_3ef2940e51a265dcff51c7d3e31dadbdb9889b67',
...
var paymentFormOrderPage = document.getElementById('paymentFormOrderPage');
var orderIdOrderPage = (document.getElementById('orderIdOrderPage') || {}).value;
if (paymentFormOrderPage) paymentFormOrderPage.addEventListener('submit', payWithPaystackOrderPage, false);
...
if (selectPriceOptions) {
  var selectPromoPrice = document.getElementById('selectPromoPrice');
  var promoQtyPriceValue = document.getElementById('inputPromoQtyPrice').value; // console.log(promoQtyPriceValue);

  var PromoQtyArray = promoQtyPriceValue.split(',');
  var newPromoQtyArray = PromoQtyArray.filter(function (e) {
    return e !== ' 0 = 0 Naira';
...
if (selectColorOptions) {
  var selectColours = document.getElementById('selectColours');
  var coloursValue = document.getElementById('productColours').value;
  var coloursOptions = coloursValue.split(',');
...
if (selectSizeOptions) {
  ...
  var sizesValue = document.getElementById('productSizes').value;
  var sizesOptions = sizesValue.split(',');
