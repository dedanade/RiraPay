...
var updateordersbtn = document.querySelector('#refresh_ordersbtn');
var updateordersbtnmobile = document.querySelector('#refresh_mobile_ordersbtn');
...
if (updateordersbtn) updateordersbtn.addEventListener('click', function () {
  (0, _update.updateOrderEmails)();
});
if (updateordersbtnmobile) updateordersbtnmobile.addEventListener('click', function () {
  (0, _update.updateOrderEmails)();
});
